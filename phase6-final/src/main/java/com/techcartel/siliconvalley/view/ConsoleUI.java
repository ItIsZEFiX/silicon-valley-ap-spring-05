...
public class ConsoleUI {
    ...
    private List<Player> setupPlayers() {
        ...
        for (int i = 1; i <= count; i++) {
            ...
            // --- CHANGED: Now we ask for the specific AI difficulty ---
            AIType aiType = chooseAIType();
    ...
    private AIType chooseAIType() {
        System.out.println("Select player control type:");
        System.out.println("  0) Human");
        System.out.println("  1) Normal AI");
        System.out.println("  2) Advanced AI");

        int choice = readIntInRange("Choice: ", 0, 2);
        return switch (choice) {
            case 1 -> AIType.NORMAL;
            case 2 -> AIType.ADVANCED;
            default -> AIType.HUMAN;
        };
    }
